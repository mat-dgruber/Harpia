...
- `[ ]` Correção do linter interno no exemplo de formulário frontend (`exemplos/frontend/formulario/main.hrp`) — *erros de declaração duplicada e identificador 'tamanho' não mapeado pelo validador local de variáveis.*
