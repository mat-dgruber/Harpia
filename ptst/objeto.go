...
// Objeto é a interface primordial e base de toda a tipagem dinâmica do Harpia.
//
// Qualquer estrutura em Go que deseje ser interpretada, manipulada ou armazenada
// como uma variável no runtime da máquina virtual do Harpia deve implementar esta interface.
//
